//package com.andreformento.myapp.two
//
...
//        client.sql("SELECT COUNT(*) as total FROM posts")
//            .map{ row -> row.get("total", Long::class.java)?: throw RuntimeException() }
//            .awaitOne()
//
//    fun findAll(): Flow<Post> =
//        client.sql("select * from posts")
//            .as(Post::class.java)
//            .fetch()
//            .flow()
//
